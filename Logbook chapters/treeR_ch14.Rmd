...
scenario_1995 <- temperature_scenario_from_records(weather = patched_complete,
                                                   year = 1995)
temps_1995 <- temperature_generation(weather = patched_complete,
                                     years = c(1994,2020),
                                     sim_years = c(2001,2100),
                                     temperature_scenario = scenario_1995)
median(patched_complete$Year)

scenario_2007 <- temperature_scenario_from_records(weather = patched_complete,
                                                   year = 2007)

relative_scenario <- temperature_scenario_baseline_adjustment(
  baseline = scenario_2007,
  temperature_scenario = scenario_1995)

temps_1980<-temperature_generation(weather = patched_complete,
                                   years = c(1994,2020),
                                   sim_years = c(2001,2100),
                                   temperature_scenario = relative_scenario)

# creating all wanted scenarios
