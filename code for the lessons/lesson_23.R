...
temps_hourly <- read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/TMaxTMin1958-2019_patched.csv") %>%
...
dc <- make_daily_chill_plot2(daychill,
                             ...
                             enddate = 30,
                             focusyears = c(2008),
                             metriclabels = "Heat (GDH)")


Alex_first <- read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/Alexander_Lucas_bloom_1958_2019.csv") %>%
...
plot_PLS(plscf,
         ...
         add_chill = c(-48,62),
         add_heat = c(-5,105.5))
# here we stopped and will continue at 12.12.2024
