...
write.csv(results,
          "D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/model_sensitivity_development.csv",
          row.names = FALSE)

head(results)

results <- read.csv("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/model_sensitivity_development.csv")
...
temperatures <- read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/TMaxTMin1958-2019_patched.csv") %>%
...
write.csv(Model_sensitivities_CKA,
          "D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/Model_sensitivities_CKA.csv",
          row.names = FALSE)
...
write.csv(Model_sensitivities_Davis,
          "D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/Model_sensitivities_Davis.csv",
          row.names = FALSE)
...
Model_sensitivities_CKA <- read.csv("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/Model_sensitivities_CKA.csv")
Model_sensitivities_Davis <- read.csv("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/Model_sensitivities_Davis.csv")
...
CKA_temperatures <- read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/TMaxTMin1958-2019_patched.csv")
Davis_weather <- read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/Davis_weather.csv")
