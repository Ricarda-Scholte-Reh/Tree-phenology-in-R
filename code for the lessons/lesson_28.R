...
data <- read.csv("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/interactive_plot_PLS.csv", sep = ";")
...
anim_save("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/interactive_experiment_plot.gif",
          animation = last_animation())


library(chillR)
library(lubridate)
pheno_data<-read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/final_bio_data_S1_S2_apple.csv")
weather_data<-read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/code for the lessons/final_weather_data_S1_S2.csv")
