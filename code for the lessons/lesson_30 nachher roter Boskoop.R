...
Fit_res <-
  phenologyFitter(par.guess = par,
                  ...
                  bloomJDays = Alex_first$pheno[which(Alex_first$Year > 1956)],
...
write.csv(Alex_par,
          "D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/PhenoFlex_parameters_roter_Boskoop.csv")



Alex_par <- 
  read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/PhenoFlex_parameters_roter_Boskoop.csv")[,2]
