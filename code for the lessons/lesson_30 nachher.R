...
Alex_first <-
  read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/Alexander_Lucas_bloom_1958_2019.csv") %>%
...
write.csv(Alex_par,
          "D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/PhenoFlex_parameters_Alexander_Lucas.csv")



Alex_par <- 
  read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/PhenoFlex_parameters_Alexander_Lucas.csv")[,2]
...
RPIQ(Alex_PhenoFlex_predictions$predicted,
     Alex_PhenoFlex_predictions$pheno)
