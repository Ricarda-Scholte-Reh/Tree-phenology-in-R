...
Alex_par <- read_tab("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/PhenoFlex_parameters_Alexander_Lucas.csv")[,2]
...
write.csv(results,
          "D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/model_sensitivity_PhenoFlex.csv")
...
Model_sensitivities_PhenoFlex <-
  read.csv("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/Logbook chapters/model_sensitivity_PhenoFlex.csv")
