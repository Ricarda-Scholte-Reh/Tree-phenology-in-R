...
patched_complete <- read.csv("D:/! Ricardas Daten/Studium/Master/03. Semester (WiSe 24-25)/Tree phenology analysis in R/patched_weather_3_Wesel.csv")
...
#write.csv(Temp_l12, "D:/! Ricardas Daten/Studium/Master/03. #Semester (WiSe 24-25)/Tree phenology analysis in #R/Temp_l12_Wesel.csv", row.names = FALSE)
#summary(Temp_l12)
#Temp_l12 <- read.csv("D:/! Ricardas Daten/Studium/Master/03. #Semester (WiSe 24-25)/Tree phenology analysis in #R/Temp_l12_Wesel.csv")
...
#Temperatures_l12$Year <- as.numeric(Temperatures_l12$Year)
#Temperatures_l12$Month <- as.numeric(Temperatures_l12$Month)
#Temperatures_l12$Day <- as.numeric(Temperatures_l12$Day)
#Temperatures_l12$Tmin <- as.numeric(Temperatures_l12$Tmin)
#Temperatures_l12$Tmax <- as.numeric(Temperatures_l12$Tmax)

Temperatures <- patched_complete %>% filter(Year %in% 1998:2005) %>%
